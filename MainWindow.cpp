...
MainWindow::createActions()
{
    ...
    m_actionBoxFilter = new QAction("Bo&xFilter", this);
    m_actionBoxFilter->setShortcut(tr("Ctrl+X"));
    m_actionBoxFilter->setData(BOXFILTER);
...
MainWindow::createMenus()
{
    ...
    m_menuNbrOps->addAction(m_actionBoxFilter	);
...
MainWindow::createGroupPanel()
{
    ...
    m_imageFilter[BOXFILTER]  = new BoxFilter;
    ...
    m_stackWidgetPanels->addWidget(m_imageFilter[BOXFILTER	 ]->controlPanel());
